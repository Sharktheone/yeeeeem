...
const interface = @import("class_file/interface.zig");
const field = @import("class_file/field.zig");
const method = @import("class_file/method.zig");
const attribute = @import("class_file/attributes.zig");
